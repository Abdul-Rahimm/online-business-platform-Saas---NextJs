  ...
  return (
    <aside
      className={
        ...
        " text-gray-500 p-4 fixed md:static md:w-auto w-full bg-customGray top-0 h-full -left-full transition-all "
      }
    >
      ...
      <nav className="flex flex-col gap-2">
        <Link
          href={"/"}
          className={asPath.length === 1 ? activeLink : inactiveLink}
        >
          <svg
        ...
        <Link
          href={"/products"}
          className={asPath.includes("/products") ? activeLink : inactiveLink}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <Link
          href={"/categories"}
          className={asPath.includes("/categories") ? activeLink : inactiveLink}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <Link
          href={"/settings"}
          className={asPath.includes("/settings") ? activeLink : inactiveLink}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
